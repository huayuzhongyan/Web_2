...
export const siteConfig: SiteConfig = {
	title: "颜",
	subtitle: "真是个笨蛋",
	siteURL: "https://blog.shinyan.top/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"https://acg1.rainw.top/",
				"https://acg2.rainw.top/",
				"https://acg3.rainw.top/",
				"https://acg4.rainw.top/",
				"https://acg5.rainw.top/",
				"https://acg6.rainw.top/",
			], // 桌面横幅图片
			mobile: [
				"https://acg1.rainw.top/",
				"https://acg2.rainw.top/",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/huayuzhongyan",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/565790565",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "https://avatars.fastly.steamstatic.com/62718ab017b98cb3fb99e2a8ef4f3bd3cafe0971_full.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "颜",
	bio: "喜欢你喵",
	typewriter: {
	...
	links: [
		...
		},
		{
			...
			url: "https://discord.gg/2WYywPke5Z",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
